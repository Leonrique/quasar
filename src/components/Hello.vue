...
export default {
   ...
   data() {
      return {
         orienting:
            window.DeviceOrientationEvent && !this.$q.platform.is.desktop,
   ...
   methods: {
      ...
      rotate(evt) {
         if (
           ...
           to evt.accelerationIncludingGravity */
            const accelX =
                  evt.acceleration.x || evt.accelerationIncludingGravity.x,
               accelY =
                  evt.acceleration.y || evt.accelerationIncludingGravity.y,
               accelZ =
                  evt.acceleration.z ||
                  evt.accelerationIncludingGravity.z - 9.81,
      ...
      orient(evt) {
         if (evt.beta === null || evt.gamma === null) {
            ...
            this.rotateX = evt.beta * 0.8
            this.rotateY = evt.gamma * -0.8
         }
      }
   },
   mounted() {
